...
Current TestFlight verification: App Store Connect accepted build `1.0.0 (3)` on 2026-08-06 and attached it to the internal Team group. The owner tester is invited. Installation and an owner journey on the distributed binary remain unverified.
